...
ggplot(group_t, aes(Intl.Charge)) + geom_boxplot() +labs(title="Osoby rezygnujące, a koszt połączeń międzynarodowych.")
ggplot(group_f, aes(Intl.Charge)) + geom_boxplot() +labs(title="Osoby nierezygnujące, a koszt połączeń międzynarodowych.")
...
#dopatrywać się w niewykfalifikowanych pracownikach biura obsługi

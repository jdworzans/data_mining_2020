...
wyniki["k.nn.1"] <- nasz.errorest(Type ~ ., Glass, partial(ipredknn, k=1))
wyniki["k.nn.2"] <- nasz.errorest(Type ~ ., Glass, partial(ipredknn, k=2))
wyniki["k.nn.3"] <- nasz.errorest(Type ~ ., Glass, partial(ipredknn, k=3))
wyniki["k.nn.4"] <- nasz.errorest(Type ~ ., Glass, partial(ipredknn, k=4))
wyniki["k.nn.10"] <- nasz.errorest(Type ~ ., Glass, partial(ipredknn, k=10))
wyniki["k.nn.15"] <- nasz.errorest(Type ~ ., Glass, partial(ipredknn, k=15))
wyniki["k.nn.20"] <- nasz.errorest(Type ~ ., Glass, partial(ipredknn, k=20))
...
kable(
  ...
  col.names=c("k=1", "k=2", "k=3", "k=4", "k=5", "k=10", "k=15", "k=20"),
  format="latex",
...
wyniki["k.nn.1.pca"] <- nasz.errorest(Type ~ ., Glass.pca, partial(ipredknn, k=1))
wyniki["k.nn.2.pca"] <- nasz.errorest(Type ~ ., Glass.pca, partial(ipredknn, k=2))
wyniki["k.nn.3.pca"] <- nasz.errorest(Type ~ ., Glass.pca, partial(ipredknn, k=3))
wyniki["k.nn.4.pca"] <- nasz.errorest(Type ~ ., Glass.pca, partial(ipredknn, k=4))
wyniki["k.nn.5.pca"] <- nasz.errorest(Type ~ ., Glass.pca, ipredknn)
wyniki["k.nn.10.pca"] <- nasz.errorest(Type ~ ., Glass.pca, partial(ipredknn, k=10))
wyniki["k.nn.15.pca"] <- nasz.errorest(Type ~ ., Glass.pca, partial(ipredknn, k=15))
wyniki["k.nn.20.pca"] <- nasz.errorest(Type ~ ., Glass.pca, partial(ipredknn, k=20))
...
kable(
  wyniki[c("k.nn.1.pca", "k.nn.2.pca", "k.nn.3.pca", "k.nn.4.pca", "k.nn.5.pca",
           "k.nn.10.pca", "k.nn.15.pca", "k.nn.20.pca")],
  col.names=c("k=1", "k=2", "k=3", "k=4", "k=5", "k=10", "k=15", "k=20"),
  format="latex",
